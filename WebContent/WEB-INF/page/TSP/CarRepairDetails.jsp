     ...
     <div class="divMain" id="divMain">
        ...
        <div class="divBtn" id="divBtn">
           <!--  &nbsp;<input type="button" value="删除" class="btn" onclick="baofei();"/> -->
             &nbsp;<a href="LIS/TSP/CarRepairAction_delect.action?id=${id }"  class="btn" onclick="baofei();">删除</a>
              &nbsp;<a href="LIS/TSP/CarRepairAction_list.action"  class="btn">返回</a>
