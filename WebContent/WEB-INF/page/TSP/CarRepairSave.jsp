...
<body>
	<s:form action="CarRepairAction_%{id==null? 'add': 'edit'}">
        ...
        <div>
            <table class="tabModel">
                ...
                <tr>
                    ...
                    <td>
                         <s:textfield name="repairPeriod" cssClass="inputText"></s:textfield>年
                    </td>
                </tr>
                <tr>
                    <td class="tabModelTip">
                    ...
                    <td>
                       ...
                       <s:textfield name="repairTime" cssClass="inputText" onclick="SelectDate(this,'yyyy-MM-dd')" readonly="readonly"></s:textfield>
                    </td>
                </tr>
                <tr>
                    <td class="tabModelTip">
                    ...
                    <td>
                        <s:textfield name="repairPlace" cssClass="inputText"></s:textfield>
                    </td>
                </tr>
                <tr>
                    <td class="tabModelTip">
                    ...
                    <td>
                        <s:textfield name="repairMoney" cssClass="inputText"></s:textfield>
                    </td>
                </tr>
                 <tr>
                    <td class="tabModelTip">
                 ...
                 <tr>
                   ...
                   <tr>
                    ...
                    <td>
                       <!--  <input type="text" class="inputText" onclick="SelectDate(this,'yyyy-MM-dd')" readonly="readonly"/> -->
                       <s:textfield name="repairCreateTime" cssClass="inputText" onclick="SelectDate(this,'yyyy-MM-dd')" readonly="readonly"></s:textfield>
                    </td>
                </tr>
                   <tr>
                    <td class="tabModelTip">
                ...
                <tr>
                    ...
                    <td>
                           <s:textarea rows="6" cols="80" name="repairDescription"></s:textarea>
                    </td>
                </tr>
            </table>
        </div>
